...
function Favorites () {
  ...
  useEffect( () => {
    Promise.all(favCoinsIDs.map(coin => getCoin(coin))).then((value) =>{
      ...
      resultingCoins.sort((a, b) => a.rank - b.rank) // Utiliza .sprt(a, b) con dos argumentos de comparción, para ordenar los favCoins en orden ascendente (rank es el número en el ranking, y viene con los datos de la API)
